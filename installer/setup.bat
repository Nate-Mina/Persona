...
echo [sabrina-setup] forcing numpy-2 compatible stack on top, resolves TTS pandas constraint...
"%DEST%\python\Scripts\pip.exe" install "numpy==2.0.2" "scipy==1.14.1" "numba==0.60.0" "llvmlite==0.43.0" "scikit-learn==1.6.1" "spacy==3.7.4" "blis==1.0.1" "pandas==2.2.3" "matplotlib==3.9.2" "transformers==4.41.0" "tokenizers==0.19.1" "huggingface-hub==0.23.4"
